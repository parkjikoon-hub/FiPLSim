...
check(auto_cross_main_size(25) == "65A", "25 total -> 65A cross main (NFTC: 30개까지)")
check(auto_cross_main_size(31) == "80A", "31 total -> 80A cross main (NFTC: 31~60)")
check(auto_cross_main_size(50) == "80A", "50 total -> 80A cross main (NFTC: 31~60)")
check(auto_cross_main_size(61) == "100A", "61 total -> 100A cross main (NFTC: 61~100)")
